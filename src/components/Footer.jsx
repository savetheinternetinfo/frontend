...
function Footer() {
  return (
    <div className="w-full bg-blue">
      <div className="bg-blue-light w-full p-4 text-center text-orange">
      ...
      <div className="w-3/4 px-4 py-8 flex mx-auto">
        <div className="w-1/3 pl-16">
          ...
          <Link className="text-orange no-underline block" to="/infos">
            Informationen
          </Link>
          <Link className="text-orange no-underline block mt-4" to="/about">
            Über Uns
          </Link>
          <Link className="text-orange no-underline block mt-4" to="/gallery">
            Galerie
          </Link>
          <Link className="text-orange no-underline block mt-4" to="/contact">
            Kontakt
          </Link>
        </div>
        <div className="w-1/3 pl-16">
          <h3 className="text-orange mb-4">Rechtlich</h3>
          <Link className="text-orange no-underline block" to="/imprint">
            Impressum
          </Link>
          <Link className="text-orange no-underline block mt-4" to="/privacy">
            Datenschutz
          </Link>
        </div>
        <div className="w-1/3 pl-16">
      ...
      <div className="w-full p-2 bg-blue-dark text-orange text-center">
