  ...
  return (
    <div className="container mx-auto -mt-10 px-6 py-8">
      ...
      <p>
        ...
        Sinne der Datenschutz-Grundverordnung (DSGVO) ist Dominic Kis,
        Sofienstraße 22, 76461 Muggensturm, Deutschland, Tel.: 0151 - 64613169,
        E-Mail: info@savetheinternet.info. Der für die Verarbeitung von
      ...
      <h2>4) Verwendung von Sozialen Medien: Social Plugins</h2>
      <h3>4.1 Facebook-Plugins mit Shariff-Lösung</h3>
      <p>
        Auf unserer Website werden sogenannte Social Plugins ("Plugins") des
        sozialen Netzwerkes Facebook verwendet, das von der Facebook Inc., 1
        Hacker Way, Menlo Park, CA 94025, USA ("Facebook") betrieben wird.
      </p>

      <p>
        Um den Schutz Ihrer Daten beim Besuch unserer Website zu erhöhen, sind
        diese Schaltflächen nicht uneingeschränkt als Plugins, sondern lediglich
        unter Verwendung eines HTML-Links in die Seite eingebunden. Durch diese
        Art der Einbindung wird gewährleistet, dass beim Aufruf einer Seite
        unserer Website, die solche Schaltflächen enthält, noch keine Verbindung
        mit den Servern von Facebook hergestellt wird. Wenn Sie auf die
        Schaltfläche klicken, öffnet sich ein neues Browserfenster und ruft die
        Seite von Facebook auf, auf der Sie (ggf. nach Eingabe Ihrer
        Login-Daten) mit den dortigen Plugins interagieren können.
      </p>
      ...
      <h3>4.2 Instagram-Plugin als Shariff-Lösung</h3>
      <p>
        Auf unserer Website werden sogenannte Social Plugins („Plugins“) des
        Online-Dienstes Instagram verwendet, das von der Instagram LLC., 1601
      ...
      <p>
        ...
        Art der Einbindung wird gewährleistet, dass beim Aufruf einer Seite
        unserer Website, die solche Schaltflächen enthält, noch keine Verbindung
        mit den Servern von Instagram hergestellt wird. Wenn Sie auf die
        Schaltfläche klicken, öffnet sich ein neues Browserfenster und ruft die
        Seite von Instagram auf, auf der Sie (ggf. nach Eingabe Ihrer
        Login-Daten) mit den dortigen Plugins interagieren können.
      </p>
      <p>
      ...
      <h3>4.3 - Twitter-Plugin als Shariff-Lösung</h3>
      <p>
        Auf unserer Website werden sogenannte Social Plugins ("Plugins") des
        Mikroblogging-Dienstes Twitter verwendet, der von der Twitter Inc., 1355
        Market St, Suite 900, San Francisco, CA 94103, USA ("Twitter") betrieben
        wird.
      </p>
      ...
      <p>
        ...
        Art der Einbindung wird gewährleistet, dass beim Aufruf einer Seite
        unserer Website, die solche Schaltflächen enthält, noch keine Verbindung
        mit den Servern von Twitter hergestellt wird. Wenn Sie auf die
        Schaltfläche klicken, öffnet sich ein neues Browserfenster und ruft die
        Seite von Twitter auf, auf der Sie (ggf. nach Eingabe Ihrer Login-Daten)
        mit den dortigen Plugins interagieren können.
      </p>
      <p>
        Twitter Inc. mit Sitz in den USA ist für das us-europäische
        Datenschutzübereinkommen „Privacy Shield“ zertifiziert, welches die
        Einhaltung des in der EU geltenden Datenschutzniveaus gewährleistet.
      </p>
      ...
      <p>
        ...
        Daten zu verlangen, solange die von Ihnen bestrittene Richtigkeit Ihrer
        Daten überprüft wird, wenn Sie eine Löschung Ihrer Daten wegen
